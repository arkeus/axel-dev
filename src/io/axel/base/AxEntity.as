package io.axel.base {
	...
	public class AxEntity extends AxRect {
		...
		private function calculateVelocity(velocity:Number, acceleration:Number, drag:Number, terminal:Number):Number {
			...
			if (acceleration == 0 || acceleration > 0 && velocity < 0 || acceleration < 0 && velocity > 0) {
		...
		/**
		 * Alias for setting acceleration.y.
		 * 
		 * @param amount The amount of gravity to apply.
		 */
		public function set gravity(amount:Number):void {
			acceleration.y = amount;
		}
		
		/**
		 * Alias for reading acceleration.y.
		 * 
