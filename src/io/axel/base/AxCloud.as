		...
		private function build():void {
			...
			for (var i:uint = 0; i < members.length; i++) {
				...
				if (moves) {
					...
					vertexData[ri1 + 0 ] = sprite.x + sprite.animations.animationTexture.frameWidth;
					vertexData[ri1 + 1 ] = sprite.y;
					
					vertexData[ri2 + 0 ] = sprite.x;
					vertexData[ri2 + 1 ] = sprite.y + sprite.animations.animationTexture.frameHeight;
					
					vertexData[ri3 + 0 ] = sprite.x + sprite.animations.animationTexture.frameWidth;
					vertexData[ri3 + 1 ] = sprite.y + sprite.animations.animationTexture.frameHeight;
				}
				...
				if (animates) {
					var uvWidth:Number = sprite.animations.animationTexture.frameWidth / sprite.texture.width;
					var uvHeight:Number = sprite.animations.animationTexture.frameHeight / sprite.texture.height;
					var u:Number = (sprite.animations.frame % sprite.animations.animationTexture.framesPerRow) * uvWidth;
					var v:Number = Math.floor(sprite.animations.frame / sprite.animations.animationTexture.framesPerRow) * uvHeight;
